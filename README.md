...
this repository is forked from andreoav/fuel-opauth on April 4, 2016

## Overview
Usable fuelPHP package for Opauth with latest Facebook SDK. 

## How to use

Almost the same as original How to use
...
1. Install this package for your FuelPHP application. Go to your FuelPHP application package folder.
  ...
  git clone git://github.com/kdotsaito/fuel-opauth.git opauth
   ```
   
2. Copy the opauth configuration file located at PKGPATH/opauth/config/opauth.php to your_fuel_app/fuel/app/config/, __change the security salt__ and tweak as you need. eg.
...
## The following is original READEME.md 
